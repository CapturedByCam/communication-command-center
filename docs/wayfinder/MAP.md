...
- [Limit Gmail V1 to the primary work mailbox and verified aliases](tickets/103-gmail-scope.md): Exclude automated and bulk mail; begin with a seven-day pilot and defer the separate 30-day backfill until acceptance.
...
Studio live starter resolution, model usefulness and retention, eligible draft creation, any mobile
